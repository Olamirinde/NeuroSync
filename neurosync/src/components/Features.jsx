...
const Features = () => {
  return (
    <div className='relative mt-20 border-b border-neutral-500 min-h-[600px]'>
        <div className="text-center">
            <span className="bg-neutral-500 text-orange-500 rounded-full h-6 text-sm font-medium px-2 py-1 uppercase">
                feature
            </span>
