    ...
    <section className='max-w-7xl mx-auto pt-20 px-6'>
        <div className='flex flex-col items-center mt-6 lg:mt-20'>
            <h1 className='text-4xl sm:text-6xl lg:text-7xl text-center -tracking-wide'>
                NeuroSync build Tools
                <span className='bg-gradient-to-r from-orange-500 to-orange-800 text-transparent bg-clip-text'>{" "}for developers</span>
            </h1>
            <p className='mt-10 text-lg text-center text-neutral-500 max-w-4xl'>Empower your creativity and bring your VR app to life with our intuitive development tools. Get started today and turn your imagination into immersive reality</p>
        </div>
