            ...
            {pricingOptions.map((option, index) => (
                <div className='w-full sm:w-1/2 lg:w-1/3 p-2' key={index}>
                    <div className="p-10 border border-neutral-700 rounded-xl">
                        ...
                        <a className='inline-flex justify-center items-center text-center w-full h-12 p-5 mt-20 tracking-tight text-xl hover:bg-orange-900 border border-orange-900 rounded-lg tranition duration-200' href="#">
                            Subscribe
                            </a>
                    </div>
                </div>
